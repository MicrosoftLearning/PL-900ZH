...
1.  创建解决方案
    ...
    -   在 **“显示名称”** 部分输入 **[Your Last Name] Campus Management**。

2.  创建发布者

    -   单击 **“发布者”** 下拉菜单并选择 **“发布者”**。

    -   在弹出的窗口中，在 **“显示名称”** 部分输入 **“Bellows College”**，在 **“前缀”** 部分输入 **“bc”**
...
3. 如果尚未选择您的 [my initials] 练习环境，请在右上角选择它。
...
4. 选择 **“导入数据”** 组件。一个新的选项卡将打开 Power Automate。如果出现弹出窗口，请单击 **“开始”**。 

5. 单击 **“运行”**，然后在提示时单击 **“运行流”**。

6. 单击 **“完成”**。

7. 等待流实例完成运行。你可以刷新 **28 天运行历史记录**表，以查看流何时运行过。该流的目的是为即将进行的实验室生成示例数据。在下一个任务中，你将验证数据导入是否成功。 
...
4. 单击 **“建筑”** 列中的任意值，请确认该“建筑”窗体在单独的窗口中打开。关闭该窗口。

5. 单击 **“游客”** 列中的任意值（你可能需要向右滚动视图），请确认联系人窗体在单独的窗口中打开。关闭该窗口。
