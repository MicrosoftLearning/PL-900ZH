...
3.  选择 **“Common Data Service”** 连接，然后单击 **“创建”**。
    ...
    -   可能会出现 **“欢迎使用 Power Apps Studio”** 窗口。单击 **“跳过”**。
...
1. 选择 **“BrowseScreen1”**，确保取消选择“BrowseGallery1”
...
8. 在表达式中，找到 `[@Visits]`，然后将其替换为 `Filter(Visits,'Scheduled End' >= DatePicker1.SelectedDate)`。整个表达式应该如下所示：
