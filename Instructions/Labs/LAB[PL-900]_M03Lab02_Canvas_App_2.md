...
4.  编辑表单视图
    ...
    -   通过拖动列表中的字段卡来更改所选字段的顺序。推荐的顺序是：访问者、建筑物、计划开始时间、计划结束时间、实际开始时间、实际结束时间
   
    -   单击 **“X”** 关闭“字段”窗格
   
5.  在仍选择窗体视图的同时，选择“属性”窗格的“高级”选项卡。选择 **“项目”** 属性，然后输入 `LookUp(Visits, Code = textCode.Text)` 

6.  要保留正在进行的工作，请单击 **“文件”**，然后单击 **“保存”**。使用后退箭头返回到应用。
...
1. 选择 **“签入”** 按钮，然后在“属性”选项卡中单击按钮的 **“DisplayMode”** 属性
...
3. 选择“签出”按钮，然后在“属性”选项卡中单击按钮的 **“DisplayMode”** 属性
...
7. 两个按钮均应禁用。输入你先前复制的代码值，然后按  **Tab** 键，将焦点从文本框移开。 **“签入”** 按钮应变为启动状态。 
...
5. 要保留正在进行的工作，请单击 **“文件”**，然后单击 **“保存”**。使用 **“后退”** 箭头返回到应用。
