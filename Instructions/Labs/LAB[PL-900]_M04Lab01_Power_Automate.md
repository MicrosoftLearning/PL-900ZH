...
9. 搜索 *“邮件”*， 选择 **“邮件”** 连接器和 **“发送电子邮件通知”** 操作 
   ...
   * 在 **“电子邮件正文”** 中输入以下文本：  
        *备注：粗体文本表示需要在这些位置插入的动态内容。建议先键入所有文本，然后在正确的位置添加动态内容。*
     >
     > 尊敬的 {**名字**}，
     >
...
10.  从**邮件**连接中添加**发送电子邮件通知**操作，然后停留在 **应用于每个循环**中

11.  将电子邮件地址输入为**收件人**

12.  输入 “逾期停留的联系人 {**全名**}”。**全名**是当前访问记录中的动态内容。

13.  输入“它发生在建筑物 **Name** 中”，其中 **Name** 是 **“GetBuilding”** 步骤中的动态内容

14.  在 **“GetUser”** 步骤中找到 **“主电子邮件”**，并将其插入“抄送”字段（会议主持人将收到电子邮件的副本）

15.  在左上角选择流名称**无标题**，并将其重命名为**安全检查**
