...
3. 在计算机上下载并保存 [visits.pbix](../../Allfiles/visits.pbix)。

4. 导航到 [https://app.powerbi.com/](https://app.powerbi.com/) 并单击 **“登录”**。 

5. 单击 **“我的工作区”**。 

6. 如果显示 **“获取数据”** 页面，请单击 **“跳过”**。 

6. 展开 **“+新建”** 并选择 **“上传文件”**。

7. 选择 **“本地文件”**。

8. 找到并选择你之前下载的 **visits.pbix** 文件。

9. 数据加载完成后，选择 **“visits”** 报表（请注意，“类型”设置为 **“报表”**）。

10. 单击 **“编辑”**。如果 **“编辑”** 菜单项不可见，请单击 **“...”**，然后选择 **“编辑”**。

11. 继续 [任务 \#3](#task-3-create-chart-and-time-visualizations)。
...
2.  打开 Power BI Desktop，如果出现提示，请登录。

2. 选择 **“获取数据”**。

3. 选择左侧的 **“Power Platform”**，然后选择 **“Common Data Service”**，最后按 **“连接”**。

4. 将你先前复制的环境 URL 粘贴到 **“服务器 URL”** 字段，按 **“确定”**。

5. 展开 **“实体”** 节点，选择 **“bc_Building”** 和 **“bc_Visit”** 实体，然后单击 **“加载”**。

6. 单击左侧垂直工具栏上的 **“模型”** 图标。

7. 拖动 **bc_Building** 表中的 **bc_buildingid** 列并将其放置到 **bc_Visit** 表中的 **bc_building** 列中 。这将在 Power BI 将能够用来显示相关数据的两个实体之间创建关系。

8. 选择左侧工具栏上的 **“报告”** 图标。

9. 展开 **“字段”** 面板中的 **bc_Visit** 节点。

10. 单击 **bc_Visit** 旁边的 **“...”**，然后选择 **“新建列”**。
...
12. 单击你刚刚创建的 **“列”** 字段旁边的 **“...”**，并选择 **“重命名”**。输入 **“建筑”** 作为字段名称。

13. 单击 **bc_visitid** 字段旁边的 **“...”**，并选择 **“重命名”**。输入 **“访问”** 作为字段名称。

14. 单击 **bc_scheduledstart** 字段旁边的 **“...”**，并选择 **“重命名”**。输入 **“开始”** 作为字段名称。

15. 要保存正在进行的工作，请按下 **“文件 \| 保存”** 并输入你选择的文件名。

## 任务 3：创建图表和时间可视化

1. 按 **“可视化效果”** 面板中的饼图 图标，以插入图表。
...
6. 如果你拥有移动设备，请使用 iOS 和 Android 平台上均可用的 QR 扫描仪应用来扫描 QR 码，如果手机支持，也可使用相机应用扫描 QR 码。如果出现提示，请登录帐户。
