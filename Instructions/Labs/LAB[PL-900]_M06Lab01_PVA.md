...
以下已被确定为完成项目必须满足的要求：
  ...
  - 仅限奖励性练习：完成实**验室 4 模块 6 - Power Apps 门户简介** 
...
> 在下一个练习中，你将基于 CDC 常见问题解答站点生成自己的主题。不要离开此浏览器窗口。
...
3.  单击打开系统主题的 **“问候”** 主题。你也可以使用搜索框来**搜索现有主题**。
...
# 挑战 
* 将你的聊天机器人嵌入到 Bellows College Visitors 门户中（有关如何执行此操作的更多信息，请参阅 **“将机器人添加到 Power Apps”** [此处](https://docs.microsoft.com/zh-cn/power-virtual-agents/publication-connect-bot-to-web-channels)）。
